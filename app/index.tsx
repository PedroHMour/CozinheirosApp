...
export default function LoginScreen() {
  ...
  const handleAuth = async () => {
    ...
    if (res.success) {
      // ✅ FEEDBACK VISUAL: Mostra o email conectado
      Alert.alert("Sucesso", `Conectado como: ${res.email}`, [
  ...
  const handleGoogle = async () => {
    ...
    if (res.success) {
      // ✅ FEEDBACK VISUAL: Mostra o email do Google
      Alert.alert("Google Login", `Conectado como: ${res.email}`, [
